...
function convertExam() {
    ...
    console.log(externalOS)
    console.log(lidsOD)
    console.log(lidsOS)
    console.log(conjscleraOD)
    console.log(conjscleraOS)
    console.log(corneaOD)
    console.log(corneaOS)
    console.log(anteriorChamberOD)
    console.log(anteriorChamberOS)
    console.log(irisOD)
    console.log(irisOS)
    console.log(lensOD)
    console.log(lensOS)
    console.log(antVitOD)
    console.log(antVitOS)
    ...
    // console.log(discOD)
    // console.log(discOS)
    // console.log(cupToDiscOD)
    // console.log(cupToDiscOS)
    // console.log(maculaOD)
    // console.log(maculaOS)
    // console.log(vesselsOD)
    // console.log(vesselsOS)
    // console.log(peripheryOD)
    // console.log(peripheryOS)
